...
const BigProjectCard = ({key, project}: Props) => {
  ...
  return (
    <div key={key} className={theme === "dark" ? "w-[32%]  px-5 py-6  cursor-pointer" : "w-[32%] border border-gray-100 px-5 py-6 rounded-lg shadow-lg hover:shadow-xl cursor-pointer"}>
