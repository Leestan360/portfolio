...
const BlogCard = ({ key, blog }: Props) => {
  ...
  return (
    <article
      key={key}
      className={theme === "dark" ? "w-[32%] bg-[#1F2938] border border-[#1F2938] hover:shadow-md hover:shadow-[#1F2938]  shadow-[#1F2938] shadow-sm rounded-lg px-6 py-4 cursor-pointer" : "  p-2 border border-gray-100 hover:shadow-xl rounded-lg shadow-lg  cursor-pointer"}
    >
