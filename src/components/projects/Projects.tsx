...
function Projects() {
  return (
    <div className="my-24">
      <h3 className="text-4xl font-[500]">Open Source Projects</h3>
      <div className="flex flex-wrap justify-between my-3 gap-y-5">
        <div className="border border-gray-100 py-5 px-7 w-[32.5%] rounded-[6px] shadow-lg  cursor-pointer my-2 hover:shadow-xl bg-white">
        ...
        <div className="border border-gray-100 py-5 px-7 w-[32.5%] rounded-[4px] shadow-lg  cursor-pointer my-2 hover:shadow-xl bg-white">
          <p className="font-[400] text-[2em] ">Project</p>
          <p className="pb-5 pt-2 text-gray-500 text-[1.3rem] leading-6">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit.
          </p>
