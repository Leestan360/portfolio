...
const ExperienceCard = ({ key, work }: Props) => {
  ...
  return (
    <div
      key={key}
      id="parent"
      className={theme === "dark" ? "sm:w-[49%] xxs:w-[100%] bg-[#1F2938] border border-[#1F2938] hover:shadow-md hover:shadow-[#1F2938]  shadow-[#1F2938] shadow-sm rounded-lg px-6 py-4 cursor-pointer  " : ""}
    >
