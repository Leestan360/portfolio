  ...
  return (
    ...
    <div className="sm:flex sm:justify-between sm:gap-4 mb-4 border-b-2 border-gray-100 pb-4">
      ...
      <div>
        ...
        <span className="text-lg font-semibold text-gray-500">{work.role}</span>
        <p className="mt-1 text-base font-normal text-gray-500">{work.date}</p>
        <p className="mt-1 text-base font-normal text-gray-500">{work.desc}</p>
      </div>
    </div>
    <div>
        <span className="text-base font-semibold text-slate-900">{"Stack: "}</span>
        <span className="mt-1 text-base font-normal text-gray-500">{work.stack.join(", ")}.</span>
      <span></span>
      <div className="mt-1">
