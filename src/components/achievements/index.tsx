    ...
    <div className="my-24">
      ...
      <div className="flex flex-wrap justify-between">
        <div className="border border-gray-300 w-[32.5%] text-center rounded-lg py-8 px-4 my-6 shadow-lg hover:shadow-xl bg-white cursor-pointer">
          ...
          <p className="font-[400] text-[1.4rem] my-2 text-[#1DA1F2]">
          ...
          <div className="flex justify-center gap-2 flex-wrap">
            <Link
              to=""
              className="border border-[#1DA1F2] bg-[#1DA1F2] text-white hover:bg-white hover:text-[#1DA1F2] ease-in duration-300 px-3 py-1 rounded-[5px] text-[0.8rem]"
            >
              Certification
            </Link>
            <Link
