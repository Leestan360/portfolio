...
function Achievements() {
  return (
    <div className="px-32 my-28">
      <h3 className="text-[2.8rem] ">Achievements And Certifications</h3>
      ...
      <div className="flex flex-wrap justify-between">
        ...
        <div className="border border-gray-300 w-[32.5%] text-center rounded-lg py-8 px-4 my-6 shadow-lg hover:shadow-xl">
