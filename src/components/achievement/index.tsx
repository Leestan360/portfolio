...
const AchievementCard = ({key, achievement}: Props) => {
  ...
  return (
      <div key={key} className={theme === "dark" ? "bg-[#1F2938] border border-[#1F2938] hover:shadow-md hover:shadow-[#1F2938]  shadow-[#1F2938] shadow-sm rounded-lg px-6 py-4 cursor-pointer" : ""}>
        <Link to="#">
