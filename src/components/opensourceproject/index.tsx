...
const OpenSourceProjectCard = ({key, project}: Props) => {
  ...
  return (
    <div key={key} className={theme === "dark" ? " pt-5 px-7 w-[23%]  cursor-pointer mt-2  " : "border border-gray-100 pt-5 px-7 w-[23%] rounded-lg shadow-lg  cursor-pointer mt-2 hover:shadow-xl "}>
